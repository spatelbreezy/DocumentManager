    ...
    for (p = 0; p < doc->number_of_paragraphs; p++) {
        ...
        for (l = 0; l < paragraph->number_of_lines; l++) {
            ...
            while (occurrence != NULL) {
                ...
                int new_line_length = strlen(line) - 
                target_length + replacement_length;
                ...
                if (new_line_length <= MAX_STR_SIZE) {
                    ...
                    strncat(temp_line, occurrence + target_length, 
                    occurrence_length - target_length);
...
int highlight_text(Document *doc, const char *target) {
    ...
    for (p = 0; p < doc->number_of_paragraphs; p++) {
        ...
        for (l = 0; l < paragraph->number_of_lines; l++) {
            ...
            while (occurrence != NULL) {
                int target_length = strlen(target);
                int highlighted_line_length = strlen(line) + 
                strlen(HIGHLIGHT_START_STR) + strlen(HIGHLIGHT_END_STR) + 1;
                ...
                occurrence = strstr(occurrence + strlen(HIGHLIGHT_START_STR) + 
                target_length + strlen(HIGHLIGHT_END_STR), target);
            }
        }
    }
    ...
    for (p = 0; p < doc->number_of_paragraphs; p++) {
        ...
        for (l = 0; l < paragraph->number_of_lines; l++) {
            ...
            while (occurrence != NULL) {
                ...
                memmove(occurrence, occurrence + target_length, 
                occurrence_length - target_length + 1);
